...
function Footer() {
  return (
    <>
      <div className="bg-slate-100 mt-40">
        <footer className="footer footer-center bg-base-300 text-base-content rounded p-10">
          <nav className=" grid-flow-col gap-4 flex justify-center">
            ...
            <a className="link link-hover cursor-pointer">Press kit</a>
          </nav>
          <br />
          <nav>
            <div className="grid-flow-col gap-4 flex justify-center cursor-pointer">
              <a>
                <svg
          ...
          <aside className="flex justify-center">
            <p>
              ...
              ConvertEase Pvt. Industries Ltd
            </p>
          </aside>
        </footer>
      </div>
